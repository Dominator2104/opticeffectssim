 ...
 *
 * cie1931.js — CIE-1931-Normspektralwertfunktionen x̄(λ), ȳ(λ), z̄(λ)
 * (2°-Normalbeobachter), 380–780 nm in Schritten von 5 nm.
 *
 * Quelle der Zahlen: CIE 1931 2° Standard Observer, wie im Datensatz
 * "CIE 1931 2 Degree Standard Observer" der Bibliothek colour-science
 * (Version 0.4.7, Modul colour/colorimetry/datasets/cmfs.py) enthalten, dort
 * nach CVRL (Colour & Vision Research Laboratory, UCL). Werte unverändert
 * übernommen, nur auf 6 gültige Stellen gekürzt.
 *
 * Spalten: [Wellenlänge in nm, x̄, ȳ, z̄]
 */
...
/** Schrittweite der Tabelle in nm. */
export const CIE_STEP_NM = 5;
